...
A Socket is a computer technology that allows computers to transfer data when connected through some means(e.g Wi-Fi/Hotspot,ethernet) using a protocol that determines how and in what structure the data gets transfered
